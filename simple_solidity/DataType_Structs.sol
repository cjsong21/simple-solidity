...
contract DataType_Structs {
   ...
   function getStudent(uint _number) public view returns(string name, string gender, uint age) {
       name = students[_number].studentName;
       gender = students[_number].gender;
       age = students[_number].age;
   }   
}